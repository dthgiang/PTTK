...
insert all
    ...
    into DICHVU values('DV02', 'Vui chơi với gấu', 399999, 'Thư giãn cơ thể cùng những chú gấu', 'Thư giãn', 'playWithBear.gif')
    into DICHVU values('DV07', 'Spa Thiên đường', 99999, 'Thư giãn cơ thể sau những giờ chạy deadline căng thẳng', 'Thư giãn', 'spa.png')
